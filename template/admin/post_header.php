...
<?php
		echo '<option value="-1" '.(Autoride_ThemeHelper::selectedIf($this->data['option']['post_header_middle_template_id'],-1,false)).'>'.esc_html__('[Default]','autoride').'</option>';
		foreach($this->data['dictionary']['template'] as $index=>$value)
...
<?php
		echo '<option value="-1" '.(Autoride_ThemeHelper::selectedIf($this->data['option']['post_header_bottom_template_id'],-1,false)).'>'.esc_html__('[Default]','autoride').'</option>';
		foreach($this->data['dictionary']['template'] as $index=>$value)
